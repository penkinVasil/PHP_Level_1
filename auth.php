...
?>
<?php if($allow):?>
	<p class="greet">Добро пожаловать, <span class="loginUp"><?=$login?></span> !</p>
	<a class="toMain" href="index.php">Главная</a>
	<a class="toBasket" href="basket.php">Корзина ( <?=$count?> )</a>
	<a class="exit" href="?logout">Выйти</a> 
	<?if (is_admin()):?>
		<a class="adminRoom" href="/admin.php">Admin Room</a>
	<?endif;?>
<?php else:?>
	<form class ="auth" method="post">
		<label>Введите ваш логин</label><br>
		<input class="area" type="text" name="login" placeholder = "admin"><br>
		<label>Введите ваш пароль</label><br>
		<input class="area" type="password" name="pass" placeholder = "123"><br>
